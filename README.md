...
- **personal/story** - Literary storytelling platform with multi-language support
- **personal/birthday** - Personal birthday celebration website with interactive elements
- **personal/Forgiveness** - Interactive relationship quiz with Firebase data storage
- **personal/Hope** - Enhanced version of the forgiveness quiz with admin panel
